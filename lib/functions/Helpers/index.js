...
exports.shouldProcessPoints = exports.getBetPoints = exports.betIsCreatedBeforePlayStarted = exports.getLatencyGroup = exports.findActualBetForPlay = exports.toOrdinal = exports.getInitialPlay = exports.gameIsActive = exports.playIsScoring = undefined;
...
var getBetPoints = exports.getBetPoints = function getBetPoints(play, bet, playStartedAt) {
  playStartedAt = playStartedAt || play.startedAt || 0;
  var betBeforePlayStarted = betIsCreatedBeforePlayStarted(bet, playStartedAt);
