...
exports.getScoredPickVariants = exports.shouldProcessPoints = exports.getBetPoints = exports.betIsCreatedBeforePlayStarted = exports.getLatencyGroup = exports.findActualBetForPlay = exports.toOrdinal = exports.getInitialPlay = exports.gameIsActive = exports.playIsScoring = undefined;
...
var getScoredPickVariants = exports.getScoredPickVariants = function getScoredPickVariants(play, points, playBonusesSystem) {
  var pickVariants = {};
  var playTypeBonuses = playBonusesSystem[play.base.type];
  var basePick = 'variant__' + play.base.type;
  var complexPick = [];
  var complexVariantPoints = 0;
