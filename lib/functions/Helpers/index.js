...
var _playTypes2 = require('../../constants/play-types');

var playTypes = _interopRequireWildcard(_playTypes2);
...
var getScoredBonusesVariants = exports.getScoredBonusesVariants = function getScoredBonusesVariants(playType, points, playBonusesSystem) {
  ...
  if (formation && !playBonusesSystem.strict) {
    var _playTypes = Object.assign({}, formation.playTypes);
    delete _playTypes[playType];
    var formationPlayTypes = Object.keys(_playTypes);
